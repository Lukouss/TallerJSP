...
public class ProyectoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Proyecto";
	...
	private ProyectoPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoPersistentManager();
		}
