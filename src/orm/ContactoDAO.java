...
public class ContactoDAO {
	...
	public static boolean save(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().saveObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().deleteObject(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Contacto contacto)throws PersistentException {
		try {
			if (contacto.getEmpresaidEmpresa() != null) {
				contacto.getEmpresaidEmpresa().contacto.remove(contacto);
			}
	...
	public static boolean refresh(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().refresh(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Contacto contacto) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().evict(contacto);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
