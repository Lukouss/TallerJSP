...
public class UsuarioDAO {
	...
	public static boolean save(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
