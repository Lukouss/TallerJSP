...
public class EmpresaDAO {
	...
	public static boolean save(orm.Empresa empresa) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().saveObject(empresa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Empresa empresa) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().deleteObject(empresa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Empresa empresa)throws PersistentException {
		try {
			...
			for(int i = 0; i < lContactos.length; i++) {
				lContactos[i].setEmpresaidEmpresa(null);
			}
	...
	public static boolean refresh(orm.Empresa empresa) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().refresh(empresa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Empresa empresa) throws PersistentException {
		try {
			orm.ProyectoPersistentManager.instance().getSession().evict(empresa);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
